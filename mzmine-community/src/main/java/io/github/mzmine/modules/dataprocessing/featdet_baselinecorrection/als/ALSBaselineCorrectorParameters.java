...
public class ALSBaselineCorrectorParameters extends AbstractBaselineCorrectorParameters {
  ...
  public static final DoubleParameter asymmetry = new DoubleParameter("Asymmetry", "Asymmetry parameter (typically 0.001-0.1)", new DecimalFormat("0.000"), 0.01);

  public static final IntegerParameter iterations = new IntegerParameter("Iterations", "Number of iterations", 3);

  public ALSBaselineCorrectorParameters() {
    super(lambda, asymmetry, iterations, applyPeakRemoval.cloneParameter(), numSamples.cloneParameter());
  }
}
