 ...
 */
public class ImageImsGap extends Gap {
   ...
   */
  public ImageImsGap(FeatureListRow peakListRow, RawDataFile rawDataFile, Range<Double> mzRange,
...
//      scan.binarySearch(featureMz, true);
  ...
  public boolean noMoreOffers(int minDataPoints) {
    bestPeakDataPoints = currentPeakDataPoints;
    if (currentPeakDataPoints != null && currentPeakDataPoints.size() >= minDataPoints) {
