...
public class PeakListOpenHandler_3_0 extends DefaultHandler implements PeakListOpenHandler {
  ...
  public void startElement(String namespaceURI, String lName, String qName, Attributes attrs)
    ...
    if (qName.equals(PeakListElementName_3_0.PEAK.getElementName())) {
      ...
      rt = Double.parseDouble(attrs.getValue(PeakListElementName_3_0.RT.getElementName())) / 60d;
      height = Double.parseDouble(attrs.getValue(PeakListElementName_3_0.HEIGHT.getElementName()));
      area = Double.parseDouble(attrs.getValue(PeakListElementName_3_0.AREA.getElementName()));
