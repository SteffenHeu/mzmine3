...
public class DataPointSorter implements Comparator<DataPoint> {
  ...
  public static final DataPointSorter ascendingMzSorter = new DataPointSorter(SortingProperty.MZ,
      SortingDirection.Ascending);
  public static final DataPointSorter descendingIntensitySorter = new DataPointSorter(
