...
public class ImageMultiThreadPeakFinderModule implements MZmineProcessingModule {

  private static final String MODULE_NAME = "Image finder (multithreaded)";
  ...
  public ExitCode runModule(@NotNull MZmineProject project, @NotNull ParameterSet parameters,
    ...
    for (FeatureList peakList : peakLists) {
      // start tasks
      Task newTask = new ImageMultiThreadPeakFinderMainTask(project, peakList, parameters, tasks,
  ...
  public @NotNull Class<? extends ParameterSet> getParameterSetClass() {
    return ImageMultiThreadPeakFinderParameters.class;
  }
